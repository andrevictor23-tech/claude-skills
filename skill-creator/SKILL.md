...
- **description**: When to trigger, what it does. This is the primary triggering mechanism - include both what the skill does AND specific contexts for when to use it. All "when to use" info goes here, not in the body. Note: make the description specific, with concrete triggers — name the actual inputs, phrases, and situations that should activate the skill (and, when useful, what is out of scope). Precision beats volume: don't inflate the description with synonym lists or generic "use whenever" padding.
