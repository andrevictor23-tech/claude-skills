...
description: Redige a representação da Autoridade Policial ao Juízo no padrão real da Delegacia de Alta Floresta/MT e do NEAMV, a partir de banco de modelos reais — prisão preventiva e temporária, busca e apreensão, quebra de sigilo (telefônico, telemático, bancário, fiscal), interceptação, acesso a dispositivo apreendido e medidas assecuratórias, com os ofícios judiciais a provedores, redes sociais, aplicativos e operadoras. Use ao pedir a peça ("representa pela preventiva", "faz o pedido de busca", "quebra o sigilo do alvo"), ao entregar autos perguntando quais medidas cabem, ou para acrescentar modelo novo à base. Não use para despacho de plantão (`despacho-plantao`) nem para relatório final de IP (`relatorio-final-ip`).
---
